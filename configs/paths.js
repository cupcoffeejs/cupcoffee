...
paths.root = config('root') || path.resolve('.');
...
paths.app = {};
paths.app.app = path.join(paths.root, 'app');
...
paths.public = {};
paths.public.public = path.join(paths.root, 'public');
...
paths.assets = {};
paths.assets.assets = path.join(paths.root, 'assets');
